...
/*+ Creación de la tabla Temporal que contendrá los Repuestos con sus precios*/
	...
	CREATE TABLE #TMP_REPUESTOS_NO_INSERTADOS(Nombre VARCHAR(100),
                                 Precio DECIMAL(18,6))
...
/*+ Se generan los registros en la tabla temporal que posteriormente se evaluarán para ver si procede su carga en la tabla definitiva de Repuestos*/
    ...
    BEGIN
        -- Verificar si el precio es menor a 20$
        IF @Precio < 20
        BEGIN
            ...
            ELSE
            BEGIN
                -- Insertar nuevo repuesto en la tabla definitiva
        ...
        ELSE
        BEGIN
            -- Repuesto con precio mayor o igual a 20$ que no se insertará
            INSERT INTO #TMP_REPUESTOS_NO_INSERTADOS VALUES (@Nombre,@Precio);
            PRINT 'Repuesto con precio mayor o igual a 20$: ' + @Nombre;
        END

        FETCH NEXT FROM cursorRepuestos INTO @Nombre, @Precio;
    END
	SELECT * FROM #TMP_REPUESTOS_NO_INSERTADOS;
    CLOSE cursorRepuestos;
    DEALLOCATE cursorRepuestos;
	DROP TABLE #TMP_RESPUESTO;
	DROP TABLE #TMP_REPUESTOS_NO_INSERTADOS;
END
